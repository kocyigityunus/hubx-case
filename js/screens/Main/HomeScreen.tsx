...
const FreePremiumView = ({ onPress }: { onPress: () => void }) => {
  return (
    <TouchableOpacity
      activeOpacity={0.8}
      onPress={onPress}
...
export const HomeScreen = () => {
  ...
  console.log({ categoriesData, isCategoriesLoading, categoriesError });
  ...
  return (
    <ScrollView
      style={{
        flex: 1,
        paddingTop: insets.top,
        paddingBottom: insets.bottom + 49, // TODO: get from bottom tab bar
    ...
    >
      ...
      <View style={{ marginHorizontal: 24, marginVertical: 24 }}>
        <FreePremiumView onPress={() => {}} />
      </View>

      {/* <ActivityIndicator size={'small'} color={colors.dark900} /> */}
      ...
      {categoriesData && (
        <FlatList
          style={{ marginTop: 24 }}
          data={categoriesData}
          contentContainerStyle={{ gap: 16, paddingHorizontal: 24, paddingBottom: 64 }}
